...
def test_generate_live_dead_backpatch_design():
    invocation_file = os.path.join(os.path.curdir, "../resources/invocation_experiment.transcriptic.2020-08-27-Strateos-YeastSTATES-Ethanol-Sytox-LiveDeadClassification.json")
